...
public final class Blocks {
     ...
     * - Block pushes
     */
    private static final Material DOORWAY_MATERIAL = new Material(MaterialColor.NONE, false, true, true, true, true, false, false, PushReaction.BLOCK);

    /**
     * A magic doorway block. Generated by a magic doorknob.
     */
    public static final RegistryObject<MagicDoorwayBlock> MAGIC_DOORWAY =
            BLOCKS.register("magic_doorway",  () -> new MagicDoorwayBlock(Block.Properties.of(DOORWAY_MATERIAL)));
    ...
    public static final RegistryObject<Block> MAGIC_DOOR =
            BLOCKS.register("magic_door", () -> new MagicDoorBlock(Block.Properties.of(DOORWAY_MATERIAL)));
