...
public final class Blocks {
    ...
    public static final RegistryObject<Block> MAGIC_DOORWAY =
            BLOCKS.register("magic_doorway",  () -> new MagicDoorwayBlock(Block.Properties.create(DOORWAY_MATERIAL)));
    ...
    public static final RegistryObject<Block> MAGIC_DOOR =
            BLOCKS.register("magic_door", () -> new MagicDoorBlock(Block.Properties.create(DOORWAY_MATERIAL)));
