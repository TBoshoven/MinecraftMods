...
public interface TextureSourceReference {
     ...
     */
    default LookupResult lookup(Function<? super ResourceLocation, ? extends TextureAtlasSprite> sprites) {
     ...
     * @return The result of the lookup.
     */
    default LookupResult lookup(Function<? super ResourceLocation, ? extends TextureAtlasSprite> sprites, @Nullable Random random) {
     ...
     * @return The result of the lookup.
     */
    LookupResult lookup(Function<? super ResourceLocation, ? extends TextureAtlasSprite> sprites, Direction direction, @Nullable Random random);
    ...
    class MaterialTextureSource implements TextureSourceReference {
         ...
         */
        public MaterialTextureSource(ResourceLocation material) {
            this.material = material;
        }

        @Override
        public LookupResult lookup(Function<? super ResourceLocation, ? extends TextureAtlasSprite> sprites, Direction direction, @Nullable Random random) {
    ...
    class BlockParticle implements TextureSourceReference {
        ...
        public LookupResult lookup(Function<? super ResourceLocation, ? extends TextureAtlasSprite> sprites, Direction direction, @Nullable Random random) {
            ...
            if (icon instanceof MissingTextureSprite) {
