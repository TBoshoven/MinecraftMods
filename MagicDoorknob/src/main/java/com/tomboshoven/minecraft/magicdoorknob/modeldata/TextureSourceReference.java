...
public interface TextureSourceReference {
     ...
     * @return The result of the lookup.
     */
    LookupResult lookup(Function<? super RenderMaterial, ? extends TextureAtlasSprite> sprites, Direction direction);
    ...
    class MaterialTextureSource implements TextureSourceReference {
        ...
        @Override
        public LookupResult lookup(Function<? super RenderMaterial, ? extends TextureAtlasSprite> sprites, Direction direction) {
