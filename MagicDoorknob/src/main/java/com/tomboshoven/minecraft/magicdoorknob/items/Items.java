...
public final class Items {
    ...
    private static Supplier<? extends Item> addDoorknob(String typeName, ToolMaterial toolMaterial, String blockName) {
        return addDoorknob(typeName, toolMaterial, Identifier.withDefaultNamespace(String.format("block/%s", blockName)), toolMaterial::repairItems, null);
    }
    ...
    private static Supplier<? extends Item> addDoorknob(String typeName, ToolMaterial toolMaterial, String blockName, Supplier<? extends Item> netheriteSmithingBase) {
        return addDoorknob(typeName, toolMaterial, Identifier.withDefaultNamespace(String.format("block/%s", blockName)), null, netheriteSmithingBase);
    }
