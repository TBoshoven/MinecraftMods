...
public final class ItemTags extends ItemTagsProvider {
     ...
     */
    public static ITag.INamedTag<Item> MAGIC_DOORKNOB = ForgeTagHandler.makeWrapperTag(ForgeRegistries.ITEMS, new ResourceLocation(MagicDoorknobMod.MOD_ID, "magic_doorknob"));
