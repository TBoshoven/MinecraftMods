...
final class ItemTags extends ItemTagsProvider {
     ...
     */
    static TagKey<Item> MAGIC_DOORKNOB = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MagicDoorknobMod.MOD_ID, "magic_doorknob"));
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        TagKey<Item> enchantableMining = TagKey.create(Registries.ITEM, ResourceLocation.withDefaultNamespace("enchantable/mining"));
