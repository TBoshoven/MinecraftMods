...
public final class MagicMirrorModifiers {
     ...
     */
    public static final Supplier<IForgeRegistry<MagicMirrorModifier>> MAGIC_MIRROR_MODIFIER_REGISTRY = MAGIC_MIRROR_MODIFIERS.makeRegistry(MagicMirrorModifier.class, RegistryBuilder::new);
