...
final class MagicMirrorCommand {
    ...
    private static int debug(CommandContext<? extends CommandSource> context) {
        ...
        int activeCount = Reflection.getActiveReflections();
        context.getSource().sendSuccess(new TranslationTextComponent("commands.magic_mirror.debug.reflections", reflectionCount, activeCount), true);
        return activeCount;
    }
