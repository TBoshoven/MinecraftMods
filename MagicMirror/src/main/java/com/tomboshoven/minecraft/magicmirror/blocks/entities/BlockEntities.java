...
public final class BlockEntities {
    ...
    static final RegistryObject<TileEntityType<MagicMirrorCoreBlockEntity>> MAGIC_MIRROR_CORE =
    ...
    static final RegistryObject<TileEntityType<MagicMirrorPartBlockEntity>> MAGIC_MIRROR_PART =
